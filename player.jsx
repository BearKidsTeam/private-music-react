...
import {
  Row, Col, Button, Checkbox, Layout, Menu, Icon, Table, Slider, Modal, Input,
} from 'antd';
import {
  StepBackwardOutlined, StepForwardOutlined, CaretRightOutlined, PauseOutlined,
...
class Player extends React.Component {
    ...
    fetchPlaylist = () => {
      axios({
        method: 'POST', url: `${this.state.source}/api.php`, data: 'do=getfilelist&folder=/', headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
      })
        .then((response) => {
    ...
    fetchMusic = (folder) => {
      axios({
        method: 'POST', url: `${this.state.source}/api.php`, data: `do=getfilelist&folder=${folder}`, headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
      })
        .then((response) => {
          this.pagination = {
      ...
      return (
        <div style={{ height: '100%' }}>
          ...
          <Layout style={{ height: '100%' }}>
            ...
            <Footer style={{
              textAlign: 'center', background: '#494949', paddingLeft: 0, paddingRight: 0,
            }}
            >
